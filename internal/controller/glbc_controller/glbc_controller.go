...
// the GlobalLoadBalancerConfig object against the actual cluster state, and then
...
func (r *GlobalLoadBalancerConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&vksvngcloudvnv1alpha1.GlobalLoadBalancerConfig{}).
