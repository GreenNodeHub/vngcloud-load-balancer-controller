...
import (
	...
	service_glb_uc "github.com/vngcloud/vngcloud-load-balancer-controller/internal/usecase/service_glb_uc"
...
func TestServiceGLBController(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "ServiceGLB Controller Suite")
}
...
var _ = BeforeSuite(func() {
	...
	// Create a Node with VKS labels so that ServiceGLB Init can read network info from node labels
	...
	// Also register GLBC reconciler so GLBC objects get reconciled (ServiceGLB creates GLBC, GLBC controller fills status)
