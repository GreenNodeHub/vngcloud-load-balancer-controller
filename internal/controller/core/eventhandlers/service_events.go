...
func NewEnqueueRequestForServiceEvent(eventRecorder record.EventRecorder,
	serviceUtils service.ServiceUtils, logger logr.Logger) *enqueueRequestsForServiceEvent {
...
func (h *enqueueRequestsForServiceEvent) enqueueManagedService(_ context.Context, queue workqueue.TypedRateLimitingInterface[reconcile.Request], service *corev1.Service) {
