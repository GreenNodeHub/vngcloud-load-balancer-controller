...
func (t *defaultModelBuildTask) buildPoolsAndListeners(ctx context.Context, targetNodeLabels map[string]string) ([]v1alpha1.GlobalPool, []v1alpha1.GlobalListener, error) {
	...
	ports := t.servicePointer.Spec.Ports
	if len(ports) <= 0 {
		return nil, nil, nil
	}
...
func (t *defaultModelBuildTask) buildPool(ctx context.Context, port corev1.ServicePort, targetNodeLabels map[string]string) (*v1alpha1.GlobalPool, error) {
	...
	// build pool members
	// For GlobalPool, members are organized by region/VPC
	// Here we create a single GlobalPoolMember with all the actual members
	...
	// Sort global members by Address:Port to ensure deterministic ordering
	// This prevents unnecessary reconciliation loops caused by array order changes
	...
	// L4 support healthcheck TCP, HTTP and HTTPS
...
// Note: GLB only supports TCP and Proxy protocols
func (t *defaultModelBuildTask) getPoolProtocol(_ corev1.Protocol) global.GlobalPoolProtocol {
	// GLB doesn't support UDP protocol, default to TCP
...
func (t *defaultModelBuildTask) getTargetType(_ context.Context) domain.TargetType {
	...
	if t.servicePointer.Spec.Type == corev1.ServiceTypeClusterIP {
		return domain.TargetTypeIP
	}

	// TODO: store somewhere to avoid parsing again and again
	var option string
	_ = t.annotationParser.ParseStringAnnotation(annotations.SuffixTargetType, &option, t.vglb.Annotations)
...
func (t *defaultModelBuildTask) buildHealthcheckPort(_ context.Context) *int {
	...
	exists, err := t.annotationParser.ParseInt64Annotation(annotations.SuffixHealthcheckPort, &optionsInt64, t.vglb.Annotations)
	if !exists {
		return nil
	}
	if err != nil {
...
func (t *defaultModelBuildTask) buildPoolAlgorithm(_ context.Context) *global.GlobalPoolAlgorithm {
	option := ""
	exist := t.annotationParser.ParseStringAnnotation(annotations.SuffixPoolAlgorithm, &option, t.vglb.Annotations)
	if !exist {
		return nil
	}
...
func (t *defaultModelBuildTask) buildIdleTimeoutClient(_ context.Context) *int32 {
	optionsInt64 := int64(0)
	exists, err := t.annotationParser.ParseInt64Annotation(annotations.SuffixIdleTimeoutClient, &optionsInt64, t.vglb.Annotations)
	if !exists {
		return nil
	}
	if err != nil {
...
func (t *defaultModelBuildTask) buildIdleTimeoutMember(_ context.Context) *int32 {
	optionsInt64 := int64(0)
	exists, err := t.annotationParser.ParseInt64Annotation(annotations.SuffixIdleTimeoutMember, &optionsInt64, t.vglb.Annotations)
	if !exists {
		return nil
	}
	if err != nil {
...
func (t *defaultModelBuildTask) buildIdleTimeoutConnection(_ context.Context) *int32 {
	optionsInt64 := int64(0)
	exists, err := t.annotationParser.ParseInt64Annotation(annotations.SuffixIdleTimeoutConnection, &optionsInt64, t.vglb.Annotations)
	if !exists {
		return nil
	}
	if err != nil {
...
func (t *defaultModelBuildTask) buildInboundCIDRs(_ context.Context) *string {
	option := []string{}
	exist := t.annotationParser.ParseStringSliceAnnotation(annotations.SuffixInboundCIDRs, &option, t.vglb.Annotations)
	if !exist {
		return nil
	}
...
func (t *defaultModelBuildTask) buildEnableProxyProtocol(_ context.Context) []string {
	option := []string{}
	exist := t.annotationParser.ParseStringSliceAnnotation(annotations.SuffixEnableProxyProtocol, &option, t.vglb.Annotations)
	if !exist {
		return nil
	}
	return option
...
func (t *defaultModelBuildTask) buildPoolHealthCheckProtocol(_ context.Context, _ corev1.Protocol) global.GlobalPoolHealthCheckProtocol {
	// Note: GLB only supports TCP, HTTP, HTTPS health check protocols (no UDP)
	option := ""
	exist := t.annotationParser.ParseStringAnnotation(annotations.SuffixHealthcheckProtocol, &option, t.vglb.Annotations)
	if !exist {
...
func (t *defaultModelBuildTask) buildPoolHealthyThresholdCount(_ context.Context) *int {
	optionsInt64 := int64(0)
	exists, err := t.annotationParser.ParseInt64Annotation(annotations.SuffixHealthyThresholdCount, &optionsInt64, t.vglb.Annotations)
	if !exists {
		return nil
	}
	if err != nil {
...
func (t *defaultModelBuildTask) buildPoolUnhealthyThresholdCount(_ context.Context) *int {
	optionsInt64 := int64(0)
	exists, err := t.annotationParser.ParseInt64Annotation(annotations.SuffixUnhealthyThresholdCount, &optionsInt64, t.vglb.Annotations)
	if !exists {
		return nil
	}
	if err != nil {
...
func (t *defaultModelBuildTask) buildPoolHealthcheckIntervalSeconds(_ context.Context) *int {
	optionsInt64 := int64(0)
	exists, err := t.annotationParser.ParseInt64Annotation(annotations.SuffixHealthcheckIntervalSeconds, &optionsInt64, t.vglb.Annotations)
	if !exists {
		return nil
	}
	if err != nil {
...
func (t *defaultModelBuildTask) buildPoolHealthcheckTimeoutSeconds(_ context.Context) *int {
	optionsInt64 := int64(0)
	exists, err := t.annotationParser.ParseInt64Annotation(annotations.SuffixHealthcheckTimeoutSeconds, &optionsInt64, t.vglb.Annotations)
	if !exists {
		return nil
	}
	if err != nil {
...
// Health check annotation methods for HTTP/HTTPS health checks

func (t *defaultModelBuildTask) buildAnnotationHealthcheckHttpMethod(_ context.Context) *global.GlobalPoolHealthCheckMethod {
	option := ""
	exist := t.annotationParser.ParseStringAnnotation(annotations.SuffixHealthcheckHttpMethod, &option, t.vglb.Annotations)
	if !exist {
		return nil
	}
	switch option {
...
func (t *defaultModelBuildTask) buildAnnotationHealthcheckPath(_ context.Context) *string {
	option := ""
	exist := t.annotationParser.ParseStringAnnotation(annotations.SuffixHealthcheckPath, &option, t.vglb.Annotations)
	if !exist {
		return nil
	}
	return &option
...
func (t *defaultModelBuildTask) buildAnnotationSuccessCodes(_ context.Context) *string {
	option := ""
	exist := t.annotationParser.ParseStringAnnotation(annotations.SuffixSuccessCodes, &option, t.vglb.Annotations)
	if !exist {
		return nil
	}
	return &option
...
func (t *defaultModelBuildTask) buildAnnotationHealthcheckHttpVersion(_ context.Context) *global.GlobalPoolHealthCheckHttpVersion {
	option := ""
	exist := t.annotationParser.ParseStringAnnotation(annotations.SuffixHealthcheckHttpVersion, &option, t.vglb.Annotations)
	if !exist {
		return nil
	}
	switch option {
...
func (t *defaultModelBuildTask) buildAnnotationHealthcheckHttpDomainName(_ context.Context) *string {
	option := ""
	exist := t.annotationParser.ParseStringAnnotation(annotations.SuffixHealthcheckHttpDomainName, &option, t.vglb.Annotations)
	if !exist {
		return nil
	}
	return &option
