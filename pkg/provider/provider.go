...
type Provider interface {
	...
	CreatePolicy(lbID, listenerID string, opt *policy.CreateOptsBuilder) (*objects.Policy, error)
	ListPolicyOfListener(lbID, listenerID string) ([]*objects.Policy, error)
	GetPolicyByID(policyID string) (*objects.Policy, error)
	UpdatePolicy(lbID, listenerID, policyID string, opt *policy.UpdateOptsBuilder) error
	...
	GetPoolByID(lbID, poolID string) (*objects.Pool, error)
